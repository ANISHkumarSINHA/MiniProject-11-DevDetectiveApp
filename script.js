...
function getUserData(gitUrl) {
  fetch(gitUrl)
    .then((response) => response.json())            //hum asyn awit hi lga lenge yha per jo lagate aa rhe h
    .then((data) => {
      console.log(data);
      updateProfile(data);
    })
...
// const prefersDarkMode = window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
  ...
  //by default, Anish ki info show krre h UI pr
  getUserData(url + "ANISHkumarSINHA");
}
